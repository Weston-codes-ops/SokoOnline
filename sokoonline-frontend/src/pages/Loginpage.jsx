...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex mx-50" >

      {/* ══ LEFT PANEL — solid green, logo + text centered left ════ */}
      <div className="hidden lg:flex lg:w-2/5 flex-col justify-center px-14 bg-[#0f4c35]">
        ...
        <p className="text-white/50 text-sm leading-relaxed">
          All you want, in one place<br />
        </p>
      </div>

      {/* ══ RIGHT PANEL — 60% width, the actual form ═══════════════ */}
      <div className="flex-1 flex flex-col bg-white">
        ...
        <div className="flex items-center justify-between px-10 py-6 border-b border-gray-100">
          ...
          <Link to="/"
            className="text-sm text-gray-400 hover:text-[#0f4c35] font-medium transition-colors">
            ← Back to home
          </Link>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center px-10">
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <a href="#" className="text-xs text-[#0f4c35] hover:underline font-medium">
                    Forgot password?
                  </a>
                </div>
              ...
              <button type="submit" disabled={loading}
                className="w-full py-3 bg-[#0f4c35] hover:bg-[#1a6b4a] text-white text-sm font-bold rounded-xl transition-colors disabled:opacity-60 disabled:cursor-not-allowed">
            ...
            <p className="text-center text-sm text-gray-400">
              ...
              <Link to="/register" className="text-[#0f4c35] font-bold hover:underline">
                Create one free
              </Link>
            </p>
          </div>
